...
- [ ] 2.5 Expressアプリケーションセットアップ
  - サーバー初期化、ミドルウェア設定
  - _Requirements: 1.1_

- [ ] 2.6 POST /renderエンドポイント実装
...
- [ ] 4.2 .dockerignore・docker-compose.yml作成
